          ...
          >
            ...
            >
              <div className="relative p-[2px] rounded-full overflow-hidden bg-white/10 shadow-[0_0_20px_rgba(255,255,255,0.1)]">
                ...
                <div className="relative bg-white rounded-full px-[32px] py-[12px] overflow-hidden">
                  ...
                  <span className="text-black text-[15px] font-semibold relative z-10">Let's Chat</span>
                </div>
              </div>
            </motion.a>
            ...
            >
              <div className="relative p-[2px] rounded-full overflow-hidden bg-white/5">
                ...
                <div className="relative bg-black/90 backdrop-blur-xl rounded-full px-[32px] py-[12px] overflow-hidden border border-white/5">
                  {/* Static Glow Effect */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[12px] bg-gradient-to-b from-white/30 to-transparent blur-[4px]" />
                  ...
                  <span className="text-white text-[15px] font-semibold relative z-10">My Work</span>
                </div>
              </div>
            </motion.a>
          </motion.div>
